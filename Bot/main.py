...
from database.db_manager import create_db, add_user, ensure_user_exists, get_user, update_points, update_level, update_health, update_user_data
...
# Define the reward amount (can be adjusted as needed)
DAILY_REWARD = 100
...
def daily_reward(client, message):
    ...
    if last_claimed != 0:
        ...
        if time_difference < 86400:  # 86400 seconds = 24 hours
            # Calculate remaining time to claim the next reward
